  ...
  return (
    <div className='py-12 bg-gray-900 text-white'>
        <div className='text-center'>
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-white sm:text-4xl">Leran with the Best</p>
        </div>
        <div className='mt-10'>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
                ...
                <div
                  ...
                  className='flex justify-center'>
                    ...
                    >
                        <div className="p-4 sm:p-6 flex flex-col items-center text-center flex-grow bg-black">
